...
/* Global define */
#define DEBUG_DATA0_ADDRESS ((volatile uint32_t *)0xE00000F4) // ที่อยู่ debug data0
#define DEBUG_DATA1_ADDRESS ((volatile uint32_t *)0xE00000F8) // ที่อยู่ debug data1
